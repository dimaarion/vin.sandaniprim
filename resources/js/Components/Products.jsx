    ...
    return <div
        ...
        <div className="p-6">
            <h5
                ...
                {localeSeparator(props.el.title, locale,selectLocaleArr)}
            </h5>
            <p className="mb-4  text-base text-neutral-600 dark:text-neutral-200">
                {props.el.discount > 0 ? <span className="text-gray-600 "><s>{props.el.price} MDL</s></span> : <span/>}
                <span className="text-gray-950">{percent(props.el.price, props.el.discount)} MDL</span>
            </p>
            <div className="thumbnail-buttons">
                <div className="text-2xl flex justify-center">
                    ...
                    {icon.length > 0 ? <div onClick={() => {
                        dispatch({type: "SETPRESENTATION", el: props.el})
                    }} className="basis-auto  w-10 h-10 justify-center flex  product-icon ">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
