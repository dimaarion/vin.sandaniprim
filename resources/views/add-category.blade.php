<h2 class="text-2xl mt-6">Добавить категорию</h2>
<form method="post" id="add-category">
    ...
    <div class="text-right">
        ...
        <div class="relative mt-6 bg-white border border-gray-200 shadow-md dark:bg-neutral-700 p-6">
            <table id="table-category" class="min-w-full text-left text-xs whitespace-nowrap">
                ...
                @foreach($category as $val)
                    <tr class="border-b dark:border-neutral-600 category_item">
                        ...
                        <td class="px-6 py-6 border-x dark:border-neutral-600 ">
                            <div class="flex justify-center gap-1">
                                <div  class="cursor-pointer hover:text-pink-950 " title="Редактировать">
                                    <div
                                        class="update-category-icon"
                                        data-id = "{{$val->id}}"
                                        data-name = "{{$val->name}}"
                                        data-subname = "{{$val->sub_name}}"
                                        data-te-toggle="modal"
                                        data-te-target="#category-update"
                                        data-te-ripple-init
                                ...
                                <div class="cursor-pointer hover:text-pink-950 delete-category" data-id = "{{$val->id}}" title="Удалить">
    ...
    <div>
        ...
        <div
            ...
            id="category-update"
            tabindex="-1"
            aria-labelledby="category-updateLabel"
            aria-hidden="true">
            <div
